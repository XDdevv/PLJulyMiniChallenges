...
@Composable
fun BottomNavUnreadBadgeOutlinedButton(
    text: String,
    ...
    OutlinedButton(
        ...
        colors = ButtonDefaults.outlinedButtonColors(
            ...
            contentColor = BottomNavigationUnreadBadgeColors.primary,
        ),
        border = BorderStroke(1.dp, BottomNavigationUnreadBadgeColors.primary),
...
@Preview
@Composable
private fun BottomNavUnreadBadgeOutlinedButtonPreview() {
